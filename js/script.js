$(document).ready(function() {
    ...
    $('.landing___country__select').bind('change', function(e) {
        $('.new-price').html($(this).find(':selected').attr('data-price'));
        $('.new-curr').html($(this).find(':selected').attr('data-currency'));
        $('.old-price').html($(this).find(':selected').attr('data-price-old') + ' ' + $(this).find(':selected').attr('data-currency'));
    });
